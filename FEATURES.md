# PDFedits Studio — Features & Status

Detailed feature tracking, the reasoning behind design decisions, and known limitations. For the short version, see [README.md](./README.md). For architecture/dev conventions, see [CLAUDE.md](./CLAUDE.md).
